...
Pod::Spec.new do |s|
  ...
  s.subspec 'PlayerCache' do |ss|
    ...
    ss.source_files        = 'Source/TTPlayerCache/TTResourceLoader{Delegate,Data,Cache,Macro}.{h,m}'
    ss.public_header_files = 'Source/TTPlayerCache/TTResourceLoader{Delegate,Data,Cache,Macro}.h'
  end
